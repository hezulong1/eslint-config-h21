...
module.exports = {
  ...
  '@typescript-eslint/class-literal-property-style': 0, // Override
  '@typescript-eslint/consistent-indexed-object-style': 0, // Override
  '@typescript-eslint/consistent-type-assertions': 0, // Override
  '@typescript-eslint/consistent-type-definitions': [2, 'interface'],
  '@typescript-eslint/consistent-type-imports': [2, { prefer: 'type-imports', disallowTypeAnnotations: false }],
  '@typescript-eslint/default-param-last': 0, // Override
  '@typescript-eslint/explicit-function-return-type': 0, // Override
  '@typescript-eslint/explicit-member-accessibility': 0, // Override
  '@typescript-eslint/explicit-module-boundary-types': 0, // Override
