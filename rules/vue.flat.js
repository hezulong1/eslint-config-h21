...
/**
 * @param {2|3} [vueVersion=3]
 * @param {boolean} [typescript]
 */
module.exports = function (vueVersion = 3, typescript) {
  return [
    {
      rules: {
        ...make_base(),
        ...make_essential(vueVersion),
        ...make_strongly_recommended(vueVersion),
        ...make_recommended(),
        ...make_uncategorized(vueVersion, typescript),
        ...make_deprecated(),
      },
    },
  ];
 ...
 */
function make_essential(vueVersion = 3) {
  ...
  return vueVersion === 3 ? vue3_essential : vue2_essential;
}
 ...
 */
function make_strongly_recommended(vueVersion = 3) {
  ...
  return vueVersion === 3 ? vue3_strongly_recommended : vue2_strongly_recommended;
}

/**
 * @see https://eslint.vuejs.org/rules/#priority-c-recommended-potentially-dangerous-patterns
 */
function make_recommended() {
  return {
 ...
 */
function make_uncategorized(vueVersion = 3, typescript) {
  ...
  return {
    ...
    'vue/no-required-prop-with-default': typescript ? 1 : 0, // TS
    ...
    'vue/require-typed-object-prop': typescript ? 1 : 0, // TS
