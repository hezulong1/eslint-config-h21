...
import type { OptionsStyle } from '../options';
 ...
 */
export async function stylistic(options: OptionsStyle = {}): Promise<Config[]> {
  const {
  ...
  return [
    {
      name: 'h21/stylistic/rules',
      plugins: {
        '@stylistic': pluginStyle,
      },
      rules: {
        ...
        '@stylistic/curly-newline': 0, // Added
        ...
        '@stylistic/indent-binary-ops': 0, // [2, indent]
        ...
        '@stylistic/no-tabs': indent === 'tab' ? 0 : 2,
        ...
        '@stylistic/object-property-newline': 0, // [2, { allowAllPropertiesOnSameLine: true }],
        ...
        '@stylistic/semi': [2, semi ? 'always' : 'never'],
        '@stylistic/semi-spacing': [2, { after: true, before: false }],
        '@stylistic/semi-style': semi ? [2, 'last'] : 0,
        ...
        ...jsx
          ? {
              ...
              '@stylistic/jsx-curly-spacing': [2, { attributes: { when: 'never' }, children: { when: 'always' } }],
              '@stylistic/jsx-equals-spacing': 2,
              '@stylistic/jsx-first-prop-new-line': 2,
              '@stylistic/jsx-function-call-newline': 0,
              // '@stylistic/jsx-indent': [2, indent, { checkAttributes: true, indentLogicalExpressions: true }],
